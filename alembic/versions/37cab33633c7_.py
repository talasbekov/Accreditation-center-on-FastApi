...
def upgrade() -> None:
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), "faceblacklists"):
        op.create_table(
            "faceblacklists",
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), "user_roles"):
        op.create_table(
            "user_roles",
            sa.Column(
                "user_id",
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), "role_permissions"):
        op.create_table(
            "role_permissions",
            sa.Column(
                "role_id",
